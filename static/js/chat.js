(function () {
  const root = document.getElementById("faq-chat-root");
  if (!root) return;

  const API_BASE = root.dataset.apiBase || "http://127.0.0.1:8000";
  ...
  launcher.addEventListener("click", () => {
    ...
    if (!messagesEl.hasChildNodes()) {
      appendMessage(
        "Привет! Я FAQ-ассистент. Задайте вопрос о нашей компании, услугах, заказах и доставке.",
        "bot"
      );
    }
